...
## Counts
- Canvas apps: 2 — wmreply_replybraryv2_c933c, wmreply_replybrary_b320d    
- Workflows: 10   
- Environment variables: 16   
- Relationship edges (total): 44; of these:
  - workflow_to_connector: 18    
  - workflow_to_env: 26 (44 total − 18 connector edges)   
- Screens: 0 (no screens found in the canvas apps)  
...
(Extracted from workflow details)  
...
## Screens per app
- No screens detected in either canvas app (both apps have empty screens lists) 

If you want this exported as a downloadable Markdown file or need the connectors/workflows mapped to specific env-vars or apps, I can produce that next.